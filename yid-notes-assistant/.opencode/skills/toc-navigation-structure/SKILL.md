...
- link to folders, categories, notes, and important aggregating files
- keep details brief
...
- Directories, category pages, important aggregating files, and individual note pages should be linked so the user can 
...
- hyperlinks for folders, category-level files, aggregating files, and ordinary notes that appear in the navigation tree
...
5. Replace plain text entries with links so the user can navigate directly from `TOC.md`.
...
- Use links consistently and by default.
